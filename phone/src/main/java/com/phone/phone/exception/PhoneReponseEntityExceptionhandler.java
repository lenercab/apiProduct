package com.phone.phone.exception;
...
@ControllerAdvice
@RestController
public class PhoneReponseEntityExceptionhandler extends ResponseEntityExceptionHandler {

    Logger logger = LoggerFactory.getLogger(PhoneReponseEntityExceptionhandler.class);
    ...
    public final ResponseEntity<Object> handlerAllEmailNotFoundException(Exception ex, WebRequest request) {
    ...
    public final ResponseEntity<Object> handlerAllPhoneNotFoundException(Exception ex, WebRequest request) {
    ...
    public final ResponseEntity<Object> handlerAllPhoneExistException(Exception ex, WebRequest request) {
