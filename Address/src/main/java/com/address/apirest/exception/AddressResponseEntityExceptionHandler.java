...
public class AddressResponseEntityExceptionHandler  extends ResponseEntityExceptionHandler {
    ...
    Logger logger = LoggerFactory.getLogger(AddressResponseEntityExceptionHandler.class);
    ...
    public final ResponseEntity<Object> handlerAllAddressNotFoundException(Exception ex, WebRequest request) {
