...
@ControllerAdvice
@RestController
public class EmailReponseEntityExceptionhandler extends ResponseEntityExceptionHandler {

    Logger logger = LoggerFactory.getLogger(EmailReponseEntityExceptionhandler.class);
